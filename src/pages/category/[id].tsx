...
const Category = ({ mode }: { mode: string }) => {
    ...
    <>
      <nav aria-label="breadcrumb">
        <ol className="breadcrumb">
          ...
          {mode === "edit" &&
            <>
              <li className="breadcrumb-item"><Link to={'/category/123/edit'}>CATEGORY_NAME</Link></li>
      ...
      <div className="mb-4 d-flex align-items-center justify-content-between">
        {mode === "edit" && <h4 className="fw-bold mb-0">CATEGORY_NAME</h4>}
        ...
        <div className="card-body">
          ...
          <div className="row g-3 mb-4">
            <div className="col-12">
              ...
              <input type="text" className="form-control" id="productNameInput" placeholder={t('category-name')}
